...
var require_middleware = __commonJS({
  ".next/server/src/middleware.js"() {
    ...
    (self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[550], { 521: (e) => {
      ...
      (() => {
        var i = { 226: function(i2, o2) {
          !function(a2, s2) {
            ...
            ee.VERSION = "1.0.35", ee.BROWSER = z([g, b, p]), ee.CPU = z([m]), ee.DEVICE = z([h, v, f, w, _, x, y, S, C]), ee.ENGINE = ee.OS = z([g, b]), typeof o2 !== u ? (i2.exports && (o2 = i2.exports = ee), o2.UAParser = ee) : r.amdO ? void 0 !== (n = function() {
              return ee;
      ...
      r.r(i), r.d(i, { config: () => tn, middleware: () => tr });
      let a = null;
      async function s() {
  ...
  `);
      ...
      class M {
        ...
        analyze() {
          ...
          let o2 = function(e11, t3) {
            ...
            i3 && E(s3.pathname, i3) && (s3.pathname = function(e12, t4) {
              if (!E(e12, t4))
                return e12;
            ...
            if (o3) {
              let e12 = t3.i18nProvider ? t3.i18nProvider.analyze(s3.pathname) : R(s3.pathname, o3.locales);
              s3.locale = e12.detectedLocale, s3.pathname = null != (n3 = e12.pathname) ? n3 : s3.pathname, !e12.detectedLocale && s3.buildId && (e12 = t3.i18nProvider ? t3.i18nProvider.analyze(l2) : R(l2, o3.locales)).detectedLocale && (s3.locale = e12.detectedLocale);
            }
            return s3;
          ...
          }(null == (t2 = this[A].options.nextConfig) ? void 0 : null == (e10 = t2.i18n) ? void 0 : e10.domains, a2);
        ...
        set locale(e10) {
          var t2, r2;
          if (!this[A].locale || !(null == (r2 = this[A].options.nextConfig) ? void 0 : null == (t2 = r2.i18n) ? void 0 : t2.locales.includes(e10)))
        ...
        clone() {
          return new M(String(this), this[A].options);
        }
      }
      var k = r(555);
      ...
      class j extends Request {
        constructor(e10, t2 = {}) {
          ...
          let n2 = new M(r2, { headers: b(this.headers), nextConfig: t2.nextConfig });
          this[L] = { cookies: new k.RequestCookies(this.headers), nextUrl: n2, url: n2.toString() };
        }
        [Symbol.for("edge-runtime.inspect.custom")]() {
      ...
      class V extends Response {
        constructor(e10, t2 = {}) {
          super(e10, t2);
          let r2 = this.headers, n2 = new Proxy(new k.ResponseCookies(r2), { get(e11, n3, i2) {
            switch (n3) {
              case "delete":
              case "set":
                return (...i3) => {
                  let o2 = Reflect.apply(e11[n3], e11, i3), a2 = new Headers(r2);
                  return o2 instanceof k.ResponseCookies && r2.set("x-middleware-set-cookie", o2.getAll().map((e12) => (0, k.stringifyCookie)(e12)).join(",")), B(t2, a2), o2;
                };
              default:
        ...
        static redirect(e10, t2) {
          ...
          return i2.set("Location", m(e10)), new V(null, { ...n2, headers: i2, status: r2 });
        }
        static rewrite(e10, t2) {
          let r2 = new Headers(null == t2 ? void 0 : t2.headers);
          return r2.set("x-middleware-rewrite", m(e10)), B(t2, r2), new V(null, { ...t2, headers: r2 });
        }
        static next(e10) {
          let t2 = new Headers(null == e10 ? void 0 : e10.headers);
          return t2.set("x-middleware-next", "1"), B(e10, t2), new V(null, { ...e10, headers: t2 });
        }
      }
      function $(e10, t2) {
      ...
      let G = "Next-Router-Prefetch", H = ["RSC", "Next-Router-State-Tree", G, "Next-HMR-Refresh", "Next-Router-Segment-Prefetch"], W = ["__nextFallback", "__nextLocale", "__nextInferredLocaleFromDefault", "__nextDefaultLocale", "__nextIsNotFound", "_rsc"], z = ["__nextDataReq"];
      ...
      }, eR = /* @__PURE__ */ new Map(), eN = n.createContextKey("next.rootSpanId"), eI = 0, eA = () => eI++, eM = { set(e10, t2, r2) {
      ...
      let eF = "undefined" != typeof globalThis && globalThis.AsyncLocalStorage, eK = eF ? new eF() : new ez();
      class eX {
        ...
        async runCallbacks() {
          ...
          let e10 = Z.getStore();
          if (!e10)
            throw new eV("Missing workStore in AfterContext.runCallbacks");
        ...
        reportTaskError(e10, t2) {
          if (console.error("promise" === e10 ? "A promise passed to `after()` rejected:" : "An error occurred in a function passed to `after()`:", t2), this.onTaskError)
            try {
              ...
              console.error(new eV("`onTaskError` threw while handling an error thrown from an `after` task", { cause: e11 }));
            }
        }
      }
      function eJ() {
      ...
      async function e4(e10) {
        ...
        let a2 = new M(e10.request.url, { headers: e10.request.headers, nextConfig: e10.request.nextConfig });
        ...
        if ((n2 = await e2(p2, () => {
          if ("/middleware" === e10.page || "/src/middleware" === e10.page) {
            let t3 = g2.waitUntil.bind(g2), r2 = new eQ();
              ...
              try {
                ...
                let h3 = eY(), f3 = (u3 = p2.nextUrl, c2 = void 0, d3 = (e11) => {
                  ...
                  return { type: "request", phase: e11, implicitTags: i3 ?? [], url: { pathname: n4.pathname, search: n4.search ?? "" }, get headers() {
                    ...
                    if (!d4.cookies) {
                      let e12 = new k.RequestCookies(K.from(t4.headers));
                    ...
                    if (!d4.mutableCookies) {
                      let e12 = function(e13, t5) {
                        let r4 = new k.RequestCookies(K.from(e13));
                ...
                return await Z.run(v3, () => ee.run(f3, e10.handler, p2, g2));
              } finally {
                setTimeout(() => {
                  r2.dispatchClose();
                }, 0);
        ...
        if (n2 && f2 && !o2) {
          let t3 = new M(f2, { forceLocale: true, headers: e10.request.headers, nextConfig: e10.request.nextConfig });
        ...
        if (n2 && v2 && !o2) {
          let t3 = new M(v2, { forceLocale: false, headers: e10.request.headers, nextConfig: e10.request.nextConfig });
        ...
        let b2 = n2 || V.next(), m2 = b2.headers.get("x-middleware-override-headers"), w2 = [];
        if (m2) {
      ...
      new TextEncoder();
      let e9 = new TextDecoder(), e5 = (e10) => {
        if (!function(e11) {
          return "object" == typeof e11 && null !== e11;
        }(e10) || "[object Object]" !== Object.prototype.toString.call(e10))
          return false;
      ...
      let tt = { NODE_ENV: "production", CLIENT_BASE: "http://localhost:3000", APP_NAME: "Hello", CLIENT_API_BASE: "http://localhost:3000", NEXT_PUBLIC_TURNSTILE_SITE_KEY: process.env.NEXT_PUBLIC_TURNSTILE_SITE_KEY };
      function tr(e10) {
        let t2 = e10.cookies.get("Authorization"), r2 = e6(t2?.value || "");
        if (!(r2 ? function(e11) {
          let t3, r3;
          if ("string" != typeof e11)
            throw new e8("JWTs must use Compact JWS serialization, JWT must be a string");
          let { 1: n2, length: i2 } = e11.split(".");
          if (5 === i2)
            throw new e8("Only JWTs using Compact JWS serialization can be decoded");
          if (3 !== i2)
            throw new e8("Invalid JWT");
          if (!n2)
            throw new e8("JWTs must contain a payload");
          try {
            t3 = function(e12) {
              if (Uint8Array.fromBase64)
                return Uint8Array.fromBase64("string" == typeof e12 ? e12 : e9.decode(e12), { alphabet: "base64url" });
              let t4 = e12;
              t4 instanceof Uint8Array && (t4 = e9.decode(t4)), t4 = t4.replace(/-/g, "+").replace(/_/g, "/").replace(/\s/g, "");
              try {
                return function(e13) {
                  if (Uint8Array.fromBase64)
                    return Uint8Array.fromBase64(e13);
                  let t5 = atob(e13), r4 = new Uint8Array(t5.length);
                  for (let e14 = 0; e14 < t5.length; e14++)
                    r4[e14] = t5.charCodeAt(e14);
                  return r4;
                }(t4);
              } catch {
            ...
            throw new e8("Failed to base64url decode the payload");
          }
          try {
            r3 = JSON.parse(e9.decode(t3));
          } catch {
            throw new e8("Failed to parse the decoded payload as JSON");
          }
          if (!e5(r3))
            throw new e8("Invalid JWT Claims Set");
          return r3;
        }(r2) : null)) {
          let e11 = V.redirect(`${tt.CLIENT_BASE}/login`);
          return e11.cookies.delete("Authorization"), e11;
        }
        return V.next();
      }
      let tn = { matcher: "/a/:path*" };
      Object.values({ NOT_FOUND: 404, FORBIDDEN: 403, UNAUTHORIZED: 401 });
      let ti = { ...i }, to = ti.middleware || ti.default, ta = "/src/middleware";
      if ("function" != typeof to)
        throw Error(`The Middleware "${ta}" must export a \`middleware\` or a \`default\` function`);
      function ts(e10) {
...
var init_edgeFunctionHandler = __esm({
  "node_modules/@opennextjs/aws/dist/core/edgeFunctionHandler.js"() {
    ...
    globalThis._ROUTES = [{ "name": "src/middleware", "page": "/", "regex": ["^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/a(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$"] }];
...
var NextConfig = { "env": { "CLIENT_BASE": "http://localhost:3000", "CLIENT_API_BASE": "http://localhost:3000", "APP_NAME": "Hello" }, "webpack": null, "eslint": { "ignoreDuringBuilds": false }, "typescript": { "ignoreBuildErrors": false, "tsconfigPath": "tsconfig.json" }, "distDir": ".next", "cleanDistDir": true, "assetPrefix": "", "cacheMaxMemorySize": 52428800, "configOrigin": "next.config.ts", "useFileSystemPublicRoutes": true, "generateEtags": true, "pageExtensions": ["tsx", "ts", "jsx", "js"], "poweredByHeader": true, "compress": true, "images": { "deviceSizes": [640, 750, 828, 1080, 1200, 1920, 2048, 3840], "imageSizes": [16, 32, 48, 64, 96, 128, 256, 384], "path": "/_next/image", "loader": "default", "loaderFile": "", "domains": [], "disableStaticImages": false, "minimumCacheTTL": 60, "formats": ["image/webp"], "dangerouslyAllowSVG": false, "contentSecurityPolicy": "script-src 'none'; frame-src 'none'; sandbox;", "contentDispositionType": "attachment", "remotePatterns": [], "unoptimized": false }, "devIndicators": { "appIsrStatus": true, "buildActivity": true, "buildActivityPosition": "bottom-right" }, "onDemandEntries": { "maxInactiveAge": 6e4, "pagesBufferLength": 5 }, "amp": { "canonicalBase": "" }, "basePath": "", "sassOptions": {}, "trailingSlash": false, "i18n": null, "productionBrowserSourceMaps": false, "excludeDefaultMomentLocales": true, "serverRuntimeConfig": {}, "publicRuntimeConfig": {}, "reactProductionProfiling": false, "reactStrictMode": null, "reactMaxHeadersLength": 6e3, "httpAgentOptions": { "keepAlive": true }, "logging": {}, "expireTime": 31536e3, "staticPageGenerationTimeout": 60, "output": "standalone", "modularizeImports": { "@mui/icons-material": { "transform": "@mui/icons-material/{{member}}" }, "lodash": { "transform": "lodash/{{member}}" } }, "outputFileTracingRoot": "/Users/haoli/Documents/self-dev/cabbage-admin", "experimental": { "cacheLife": { "default": { "stale": 300, "revalidate": 900, "expire": 4294967294 }, "seconds": { "stale": 0, "revalidate": 1, "expire": 60 }, "minutes": { "stale": 300, "revalidate": 60, "expire": 3600 }, "hours": { "stale": 300, "revalidate": 3600, "expire": 86400 }, "days": { "stale": 300, "revalidate": 86400, "expire": 604800 }, "weeks": { "stale": 300, "revalidate": 604800, "expire": 2592e3 }, "max": { "stale": 300, "revalidate": 2592e3, "expire": 4294967294 } }, "cacheHandlers": {}, "cssChunking": true, "multiZoneDraftMode": false, "appNavFailHandling": false, "prerenderEarlyExit": true, "serverMinification": true, "serverSourceMaps": false, "linkNoTouchStart": false, "caseSensitiveRoutes": false, "clientSegmentCache": false, "preloadEntriesOnStart": true, "clientRouterFilter": true, "clientRouterFilterRedirects": false, "fetchCacheKeyPrefix": "", "middlewarePrefetch": "flexible", "optimisticClientCache": true, "manualClientBasePath": false, "cpus": 9, "memoryBasedWorkersCount": false, "imgOptConcurrency": null, "imgOptTimeoutInSeconds": 7, "imgOptMaxInputPixels": 268402689, "imgOptSequentialRead": null, "isrFlushToDisk": true, "workerThreads": false, "optimizeCss": false, "nextScriptWorkers": false, "scrollRestoration": false, "externalDir": false, "disableOptimizedLoading": false, "gzipSize": true, "craCompat": false, "esmExternals": true, "fullySpecified": false, "swcTraceProfiling": false, "forceSwcTransforms": false, "largePageDataBytes": 128e3, "turbo": { "root": "/Users/haoli/Documents/self-dev/cabbage-admin" }, "typedRoutes": false, "typedEnv": false, "parallelServerCompiles": false, "parallelServerBuildTraces": false, "ppr": false, "authInterrupts": false, "reactOwnerStack": false, "webpackMemoryOptimizations": false, "optimizeServerReact": true, "useEarlyImport": false, "staleTimes": { "dynamic": 0, "static": 300 }, "serverComponentsHmrCache": true, "staticGenerationMaxConcurrency": 8, "staticGenerationMinPagesPerWorker": 25, "dynamicIO": false, "inlineCss": false, "optimizePackageImports": ["lucide-react", "date-fns", "lodash-es", "ramda", "antd", "react-bootstrap", "ahooks", "@ant-design/icons", "@headlessui/react", "@headlessui-float/react", "@heroicons/react/20/solid", "@heroicons/react/24/solid", "@heroicons/react/24/outline", "@visx/visx", "@tremor/react", "rxjs", "@mui/material", "@mui/icons-material", "recharts", "react-use", "effect", "@effect/schema", "@effect/platform", "@effect/platform-node", "@effect/platform-browser", "@effect/platform-bun", "@effect/sql", "@effect/sql-mssql", "@effect/sql-mysql2", "@effect/sql-pg", "@effect/sql-squlite-node", "@effect/sql-squlite-bun", "@effect/sql-squlite-wasm", "@effect/sql-squlite-react-native", "@effect/rpc", "@effect/rpc-http", "@effect/typeclass", "@effect/experimental", "@effect/opentelemetry", "@material-ui/core", "@material-ui/icons", "@tabler/icons-react", "mui-core", "react-icons/ai", "react-icons/bi", "react-icons/bs", "react-icons/cg", "react-icons/ci", "react-icons/di", "react-icons/fa", "react-icons/fa6", "react-icons/fc", "react-icons/fi", "react-icons/gi", "react-icons/go", "react-icons/gr", "react-icons/hi", "react-icons/hi2", "react-icons/im", "react-icons/io", "react-icons/io5", "react-icons/lia", "react-icons/lib", "react-icons/lu", "react-icons/md", "react-icons/pi", "react-icons/ri", "react-icons/rx", "react-icons/si", "react-icons/sl", "react-icons/tb", "react-icons/tfi", "react-icons/ti", "react-icons/vsc", "react-icons/wi"], "trustHostHeader": false, "isExperimentalCompile": false }, "bundlePagesRouterDependencies": false, "configFileName": "next.config.ts", "_originalRewrites": { "beforeFiles": [], "afterFiles": [{ "source": "/d/:path*", "destination": "http://localhost:4321/api/:path*" }, { "source": "/o/:path*", "destination": "http://localhost:4321/api/asset/files/:path*" }], "fallback": [] } };
var BuildId = "ibVehBci21htpHhXp75zz";
var RoutesManifest = { "basePath": "", "rewrites": { "beforeFiles": [], "afterFiles": [{ "source": "/d/:path*", "destination": "http://localhost:4321/api/:path*", "regex": "^/d(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }, { "source": "/o/:path*", "destination": "http://localhost:4321/api/asset/files/:path*", "regex": "^/o(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))?(?:/)?$" }], "fallback": [] }, "redirects": [{ "source": "/:path+/", "destination": "/:path+", "internal": true, "statusCode": 308, "regex": "^(?:/((?:[^/]+?)(?:/(?:[^/]+?))*))/$" }], "routes": { "static": [{ "page": "/_not-found", "regex": "^/_not\\-found(?:/)?$", "routeKeys": {}, "namedRegex": "^/_not\\-found(?:/)?$" }, { "page": "/a", "regex": "^/a(?:/)?$", "routeKeys": {}, "namedRegex": "^/a(?:/)?$" }, { "page": "/a/asset", "regex": "^/a/asset(?:/)?$", "routeKeys": {}, "namedRegex": "^/a/asset(?:/)?$" }, { "page": "/a/record", "regex": "^/a/record(?:/)?$", "routeKeys": {}, "namedRegex": "^/a/record(?:/)?$" }, { "page": "/a/record-report", "regex": "^/a/record\\-report(?:/)?$", "routeKeys": {}, "namedRegex": "^/a/record\\-report(?:/)?$" }, { "page": "/a/url", "regex": "^/a/url(?:/)?$", "routeKeys": {}, "namedRegex": "^/a/url(?:/)?$" }, { "page": "/favicon.ico", "regex": "^/favicon\\.ico(?:/)?$", "routeKeys": {}, "namedRegex": "^/favicon\\.ico(?:/)?$" }, { "page": "/login", "regex": "^/login(?:/)?$", "routeKeys": {}, "namedRegex": "^/login(?:/)?$" }], "dynamic": [], "data": { "static": [], "dynamic": [] } }, "locales": [] };
var ConfigHeaders = [];
var PrerenderManifest = { "version": 4, "routes": { "/a": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/a", "dataRoute": "/a.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/favicon.ico": { "initialHeaders": { "cache-control": "public, max-age=0, must-revalidate", "content-type": "image/x-icon", "x-next-cache-tags": "_N_T_/layout,_N_T_/favicon.ico/layout,_N_T_/favicon.ico/route,_N_T_/favicon.ico" }, "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/favicon.ico", "dataRoute": null, "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/login": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/login", "dataRoute": "/login.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/a/record-report": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/a/record-report", "dataRoute": "/a/record-report.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/a/asset": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/a/asset", "dataRoute": "/a/asset.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/a/url": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/a/url", "dataRoute": "/a/url.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] }, "/a/record": { "experimentalBypassFor": [{ "type": "header", "key": "Next-Action" }, { "type": "header", "key": "content-type", "value": "multipart/form-data;.*" }], "initialRevalidateSeconds": false, "srcRoute": "/a/record", "dataRoute": "/a/record.rsc", "allowHeader": ["host", "x-matched-path", "x-prerender-revalidate", "x-prerender-revalidate-if-generated", "x-next-revalidated-tags", "x-next-revalidate-tag-token"] } }, "dynamicRoutes": {}, "notFoundRoutes": [], "preview": { "previewModeId": "de13255d2d266dbf908aecb185f6c74a", "previewModeSigningKey": "ecd80d6366da777e831dc310fcbbe83de2d495d1cbec9bca595414757ee72fd2", "previewModeEncryptionKey": "b3b540cb44997c4af022071d19cef0e7dfc6ae36032528ec9e233be08128d307" } };
var MiddlewareManifest = { "version": 3, "middleware": { "/": { "files": ["server/edge-runtime-webpack.js", "server/src/middleware.js"], "name": "src/middleware", "page": "/", "matchers": [{ "regexp": "^(?:\\/(_next\\/data\\/[^/]{1,}))?\\/a(?:\\/((?:[^\\/#\\?]+?)(?:\\/(?:[^\\/#\\?]+?))*))?(\\.json)?[\\/#\\?]?$", "originalSource": "/a/:path*" }], "wasm": [], "assets": [], "env": { "__NEXT_BUILD_ID": "ibVehBci21htpHhXp75zz", "NEXT_SERVER_ACTIONS_ENCRYPTION_KEY": "nh84Y/UiLjPqG+cikU8dURV/2frwCH8UjB6TlvtOSI8=", "__NEXT_PREVIEW_MODE_ID": "de13255d2d266dbf908aecb185f6c74a", "__NEXT_PREVIEW_MODE_ENCRYPTION_KEY": "b3b540cb44997c4af022071d19cef0e7dfc6ae36032528ec9e233be08128d307", "__NEXT_PREVIEW_MODE_SIGNING_KEY": "ecd80d6366da777e831dc310fcbbe83de2d495d1cbec9bca595414757ee72fd2" } } }, "functions": {}, "sortedMiddleware": ["/"] };
var AppPathRoutesManifest = { "/_not-found/page": "/_not-found", "/favicon.ico/route": "/favicon.ico", "/login/page": "/login", "/(authorization)/a/record-report/page": "/a/record-report", "/(authorization)/a/record/page": "/a/record", "/(authorization)/a/asset/page": "/a/asset", "/(authorization)/a/page": "/a", "/(authorization)/a/url/page": "/a/url" };
